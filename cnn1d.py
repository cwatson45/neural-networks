...
model.add(Conv2D(64, (5,1), activation='relu', activity_regularizer = regularizers.l2(reg)))
model.add(Dropout(rate = .5))
model.add(Conv2D(32, (5,1), activation='relu', activity_regularizer = regularizers.l2(reg)))
model.add(Dropout(rate = .5))
model.add(Conv2D(10, (5,1), activation='relu',activity_regularizer = regularizers.l2(reg)))
model.add(Dropout(rate = .5))
model.add(Flatten())
